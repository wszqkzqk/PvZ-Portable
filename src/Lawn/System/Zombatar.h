...
{
	ZOMBATAR_SLOT_SKIN_COLOR = 0,
	ZOMBATAR_SLOT_CLOTHES_COLOR = 1,
	ZOMBATAR_SLOT_TIDBITS_COLOR = 2,
	ZOMBATAR_SLOT_ACCESSORY_COLOR = 3,
	ZOMBATAR_SLOT_FACIAL_HAIR_COLOR = 4,
	ZOMBATAR_SLOT_HAIR_COLOR = 5,
	ZOMBATAR_SLOT_EYEWEAR_COLOR = 6,
	ZOMBATAR_SLOT_HATS_COLOR = 7,
	ZOMBATAR_SLOT_BACKGROUND_COLOR = 8,
	ZOMBATAR_SLOT_SKIN_PART = 9,
	ZOMBATAR_SLOT_CLOTHES = 10,
	ZOMBATAR_SLOT_TIDBITS = 11,
	ZOMBATAR_SLOT_ACCESSORY = 12,
	ZOMBATAR_SLOT_FACIAL_HAIR = 13,
	ZOMBATAR_SLOT_HAIR = 14,
	ZOMBATAR_SLOT_EYEWEAR = 15,
	ZOMBATAR_SLOT_HATS = 16,
	ZOMBATAR_SLOT_BACKGROUND = 17
};
